...
(function () {
      ...
      fire: function () {
        ...
        return function (i, j, n) {
          ...
          if (g) {
            var s = g.listeners;
            if (s.length)
              for (var s = s.slice(0), z, o = 0; o < s.length; o++) {
                if (g.errorProof) try {
                  z =
                    s[o].call(this, n, j, b, h)
                } catch (p) {} else z = s[o].call(this, n, j, b, h);
  ...
  (function () {
    ...
    CKEDITOR.tools = {
      ...
      normalizeCssText: function (a, b) {
        var c = [],
          i, d = CKEDITOR.tools.parseCssText(a, true, b);
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    clone: function (a, d) {
      function b(c) {
        ...
        if (!(c.nodeType != CKEDITOR.NODE_ELEMENT && c.nodeType != CKEDITOR.NODE_DOCUMENT_FRAGMENT)) {
          ...
          if (a)
            for (var c = c.childNodes, e = 0; e < c.length; e++) b(c[e])
        }
      }
    ...
    getPosition: function (a) {
      ...
      for (var d = this.getAddress(), a = a.getAddress(),
          b = Math.min(d.length, a.length), c = 0; c <= b - 1; c++)
        if (d[c] != a[c]) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      removeStyle: function (a) {
        ...
        if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
          ...
          for (var b = [], d = 0; d < c.length; d++)
            if (g)
              for (var s = 0; s < g.length; s++) b.push([a, c[d], g[s]].join("-"));
      ...
      getDocumentPosition: function (a) {
        var b = 0,
          ...
          g = this.getDocument(),
          d = g.getBody(),
          s = g.$.compatMode == "BackCompat";
        if (document.documentElement.getBoundingClientRect) {
          var e = this.$.getBoundingClientRect(),
            o = g.$.documentElement,
            p = o.clientTop || d.$.clientTop || 0,
      ...
      copyAttributes: function (a, b) {
        for (var c = this.$.attributes, b = b || {}, g = 0; g < c.length; g++) {
          var d = c[g],
            ...
            f;
          if (!(e in b))
            if (e == "checked" && (f = this.getAttribute(e))) a.setAttribute(e, f);
      ...
      forEach: function (a, b, c) {
        ...
        if (g !== false)
          for (var c = this.getChildren(), d = 0; d < c.count(); d++) {
            g = c.getItem(d);
    ...
    function d(a, b, c, d, o) {
      ...
      function h() {
        ...
        if (b < v - 1 || b < L - 1 || c) {
          ...
          if (d)
            if ((b = J[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT) {
      ...
      moveToBookmark: function (a) {
        if (a.is2) {
          var b = this.document.getByAddress(a.start, a.normalized),
            c = a.startOffset,
            d = a.end &&
            this.document.getByAddress(a.end, a.normalized),
            a = a.endOffset;
          this.setStart(b, c);
      ...
      enlarge: function (a, b) {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
              ...
              for (; l;) {
                ...
                if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                  ...
                  if (l.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (k && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                      F = l.getText();
                      if (d.test(F)) l = null;
                      else
                        for (var w = l.$.getElementsByTagName("*"), H = 0, A; A = w[H++];)
            ...
            if (m.type == CKEDITOR.NODE_TEXT)
              if (CKEDITOR.tools.trim(m.substring(w)).length) k = true;
              else {
                k = !m.getLength();
                if (w == m.getLength()) {
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var E, r, J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                br: 1
              } : null),
              D = null,
              y = function (a) {
                if (a.type ==
                  CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")
                  if (D) {
                    if (D.equals(a)) {
                      D = null;
                      return
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          if (e && e.type == CKEDITOR.NODE_TEXT)
            if (h)
              if (h >= e.getLength()) d.setStartAfter(e);
              else {
                d.setStartBefore(e);
                j = 0
              }
          ...
          if (f && f.type == CKEDITOR.NODE_TEXT)
            if (i)
              if (i >= f.getLength()) d.setEndAfter(f);
              else {
                d.setEndAfter(f);
                n = 0
              }
  ...
  (function () {
    ...
    function b(a, c, e, f) {
      ...
      if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) &&
        !h.check(c)) return b(a, c, e, f.remaining);c = new CKEDITOR.dom.range(f.element);c.selectNodeContents(f.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
        element: f.element,
        container: e,
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          h = p.startPath();
          var t = p.endPath(),
            x = !p.collapsed && c(p, h.block),
            u = !p.collapsed && c(p, t.block, 1);
        ...
        for (this._.nextNode = null; t;) {
          var x = 0,
            u = t.hasAscendant("pre"),
            C = t.type != CKEDITOR.NODE_ELEMENT,
            l = 0;
          if (C) t.type == CKEDITOR.NODE_TEXT && e.test(t.getText()) &&
            ...
            if (CKEDITOR.dtd.$block[q] && t.getAttribute("contenteditable") == "false") {
              ...
              b(this, a, d);
              break
            } else if (t.isBlockBoundary(this.forceBrBreak && !u && {
                br: 1
              })) {
              if (q == "br") C = 1;
  ...
  (function () {
    ...
    function z(a, b, k, e) {
      ...
      if (e.doCallbacks && a.elementCallbacks) {
        a: for (var g = a.elementCallbacks, v = 0, w = g.length, r; v < w; ++v)
          if (r = g[v](b)) {
            f = r;
            break a
          }if (f) return f
      ...
      if (e.doTransform)
        if (f = a._.transformations[b.name]) {
          s(b);
        ...
        a: {
          g = b.name;
          v = a._;a = v.allowedRules.elements[g];f = v.allowedRules.generic;g = v.disallowedRules.elements[g];v = v.disallowedRules.generic;w = e.skipRequired;r = {
            valid: false,
            validAttributes: {},
            validClasses: {},
            validStyles: {},
        ...
        o = a.validAttributes;
        var F = a.validStyles;f = a.validClasses;
        var g = b.attributes,
          l = b.styles,
          v = b.classes,
          w = b.classBackup,
          y = b.styleBackup,
          D, L, i = [];r = [];
        var H = /^data-cke-/;h = false;delete g.style;delete g["class"];delete b.classBackup;delete b.styleBackup;
        if (!a.allAttributes)
          for (D in g)
            if (!o[D])
              if (H.test(D)) {
            ...
            a: {
              ...
              if (m)
                for (h = 0; h < m.length; ++h)
                  if ((r = d.match(m[h])) && r[0].length == d.length) {
                    c = true;
                    break a
                  } d = CKEDITOR.htmlParser.fragment.fromHtml(d);d.children.length == 1 && (w = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(k, w, c, v);c = !c.length
            }
            c || e.push(a)
          }
        }, null, true);
        ...
        h = function (b) {
          a.call(this, b, function (a) {
            ...
            for (g in a) {
              ...
              if (!d[g]) {
                if (i.icons)
                  for (var z = i.icons.split(","), o = z.length; o--;) CKEDITOR.skin.addIcon(z[o], i.path + "icons/" + (CKEDITOR.env.hidpi && i.hidpi ? "hidpi/" : "") + z[o] + ".png");
                d[g] = 1
              }
              if (s) {
                s.split && (s = s.split(","));
    ...
    function g(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var h in c) {
          ...
          if (E && (r = E.match(g)))
            for (; E = r.pop();) CKEDITOR.tools.setTimeout(function (a, b) {
          ...
          if (a(k)) t.push(k);
            ...
            if (e == "br") x.push(k);
              ...
              for (;;) {
                ...
                if (!k.isUnknown && !u.isUnknown && !g[e])
                  if (u.isOptionalClose) o.onTagClose(f);
        ...
        return function (e) {
          if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var g = [],
              ...
              r, h;
            if (v)
              for (m(v, 1) && g.push(v); v;) {
                if (f(v) && (r = c(v)) && m(r))
                  if ((h = c(r)) && !f(h)) g.push(r);
                  else {
                    k(w).insertAfter(r);
                    r.remove()
                  } v = v.previous
            ...
            if (g = !a || (typeof d == "function" ? d(e) : d) !== false)
              if (!w && !CKEDITOR.env.needsBrFiller &&
  ...
  (function () {
                  ...
                  a: {
                    ...
                    if (f)
                      if (d[c ? "checkStartOfBlock" : "checkEndOfBlock"]())
                        if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) g = false;
                        else {
    ...
    var o = CKEDITOR.dom.walker.whitespaces(true),
      p = CKEDITOR.dom.walker.bookmark(false, true),
      ...
      C = function () {
        ...
        return function (l, y, v, q) {
          ...
          if (!q.checkReadOnly()) {
            var E = (new CKEDITOR.dom.elementPath(q.startContainer, q.root)).blockLimit || q.root,
              l = {
                type: y,
                dontFilter: o,
                editable: l,
            ...
            if (!y.collapsed) {
              var n = E.block || E.blockLimit,
                z = y.getCommonAncestor();
              n && (!n.equals(z) && !n.contains(z) && y.checkEndOfBlock()) && l.zombies.push(n);
              y.deleteContents()
            }
            for (;
              (p = a(y.startContainer) && y.startContainer.getChild(y.startOffset - 1)) && a(p) && p.isBlockBoundary() && o.contains(p);) y.moveToPosition(p, CKEDITOR.POSITION_BEFORE_END);
            ...
            for (W = I.createBookmark(); x = l.zombies.pop();)
              if (x.getParent()) {
                C = I.clone();
                C.moveToElementEditStart(x);
                C.removeEmptyBlocksAtEnd()
              } if (V)
              for (; x = V.pop();) CKEDITOR.env.needsBrFiller ? x.appendBogus() : x.append(I.document.createText(" "));
    ...
    a = {
      detect: function (a, b) {
        var c = a.range,
          d = c.clone(),
          e = c.clone(),
          g = new CKEDITOR.dom.elementPath(c.startContainer,
            b),
  ...
  (function () {
    ...
    var z, o, p = CKEDITOR.dom.walker.invisible(1),
      t = function () {
        function a(b) {
          return function (a) {
    ...
    CKEDITOR.on("instanceCreated", function (b) {
      ...
      e.on("contentDom", function () {
        ...
        CKEDITOR.env.gecko && l.attachListener(l, "focus", function (a) {
          a.removeListener();
          if (q !== 0)
            if ((a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == l.$) {
              a = e.createRange();
    ...
    var x = typeof window.getSelection != "function",
      u = 1;
    ...
    CKEDITOR.dom.selection.prototype = {
      ...
      getRanges: function () {
        var a = x ? function () {
          ...
          var b = function (b, c) {
            ...
            return {
              container: j,
              offset: i > 0 ? -h : j.nodeValue.length + h
            }
          };
          return function () {
            var a = this.getNative(),
      ...
      getSelectedText: function () {
        ...
        var b = this.getNative(),
          b = x ? b.type == "Control" ? "" : b.createRange().text : b.toString();
        ...
        for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
          ...
          if (m.equals(o)) {
            ...
            if (p && j && CKEDITOR.dtd.$block[q])
              for (var w = m, B = c(w), x = void 0, A = B.length, C = 0, w = A && new CKEDITOR.dom.range(w.getDocument()); C < A; ++C) {
                var x = B[C],
                  F = CKEDITOR.filter.instances[x.data("cke-filter")];
                if (F ? F.check(this) : 1) {
            ...
            if (B)
              if ((B = m.getParent()) && ((B.getDtd() || CKEDITOR.dtd.span)[g] || h) && (!f.parentRule || f.parentRule(B))) {
                ...
                if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                  for (var q = m, S;
                    (i = !q.getNext(H)) && (S = q.getParent(), k[S.getName()]) && (S.getPosition(n) | E) == E && (!f.childRule || f.childRule(S));) q = S;
                  s.setEndAfter(q)
                }
              } else i = true;
            else i = true;
          ...
          if (i && s && !s.collapsed) {
            for (var i = t(this, e), p = i.hasAttributes(), u = s.getCommonAncestor(), q = {}, B = {}, x = {}, A = {}, R, P, X; i && u;) {
              if (u.getName() == g) {
                ...
                for (P in f.styles)
                  if (!x[P] && (X = u.getStyle(P))) i.getStyle(P) == X ? q[P] = 1 : x[P] = 1
              }
              u = u.getParent()
            }
            ...
            for (var h in c)
              if (h != "_length") {
                ...
                if (h == "style") a: {
                  ...
                  "string" && (e = CKEDITOR.tools.parseCssText(e, true));f = void 0;
                  for (f in d)
  ...
  */
        ...
        reset: function () {
          function b() {
            ...
            d.$.write(['<html dir="' + g + '" lang="' + i + '"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">',
              ...
              "window.parent.CKEDITOR.tools.callFunction(" + e + ");", "window.onbeforeunload = function() {window.parent.CKEDITOR.tools.callFunction(" + k + ")}", "<\/script>"
            ].join(""));
            d.$.close();
  ...
  (function () {
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      CKEDITOR.event.call(this);
      this.definition =
        f = CKEDITOR.fire("dialogDefinition", {
          name: b,
          definition: f
        }, a).definition;
      ...
      if (a._.removeDialogTabs && (i = a._.removeDialogTabs[b]))
        for (l = 0; l < i.length; l++) f.removeContents(i[l]);
      ...
      addPage: function (a) {
        if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
          ...
          c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"', 0 < this._.pageCount ?
            " cke_last" : "cke_first", c, a.hidden ? ' style="display:none"' : "", ' id="', d, '"', e.gecko && !e.hc ? "" : ' href="javascript:void(0)"', ' tabIndex="-1" hidefocus="true" role="tab">', a.label, "</a>"
          ].join(""));
  ...
  (function () {
    ...
    function v(b) {
      ...
      function s() {
        if (!CKEDITOR.env.ie) return b.fire("beforePaste", {
            type: "auto",
            method: "paste"
          }),
          !1;
      ...
      function l(a) {
        var d = {
            type: "auto",
            method: "paste",
            dataTransfer: o.initPasteDataTransfer(a)
          },
      ...
      var o = CKEDITOR.plugins.clipboard,
        m = 0,
        r = 0,
        u = 0,
    ...
    function A(b) {
      ...
      b.on("contentDom", function () {
        ...
        var h = b.editable(),
          i = CKEDITOR.plugins.clipboard.getDropTarget(b),
          s = b.ui.space("top"),
          t = b.ui.space("bottom");
        s && s.on("dragover", c);
        t && t.on("dragover", c);
      ...
      init: function (b) {
        ...
        b.on("paste", function (a) {
          var a = a.data,
            e = a.type,
            f = a.dataValue,
            g, h = b.config.clipboard_defaultContentType || "html",
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      getRangeAtDropPosition: function (b, a) {
        var c = b.data.$,
          d = c.clientX,
          e = c.clientY,
          f = a.getSelection(!0).getRanges()[0],
          g = a.createRange();
          ...
          if (document.body.createTextRange) {
            ...
            try {
              ...
              if (h) {
                ...
                var n =
                  a.document.$.elementFromPoint(d, e),
                  o = new CKEDITOR.dom.element(n),
                  p;
    ...
    CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
      ...
      isEmpty: function () {
        ...
        if (this.$)
          if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported) {
            if (this.$.types)
              for (var c = 0; c < this.$.types.length; c++) b[this.$.types[c]] =
                1
          ...
          if (i && k) {
            if (c && (c.is("li") || c.getParent().is("li"))) {
              ...
              if (e.is("li")) h || m ? (h && m && a.remove(), c[m ? "insertAfter" : "insertBefore"](e)) : c.breakParent(e);
                ...
                if (b)
                  if (j.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), n && e.setAttribute("dir", i), o && e.setAttribute("style", o), k && e.setAttribute("class", k), c.moveChildren(e)) : e = j.block, h || m) e[h ? "insertBefore" : "insertAfter"](a);
                  else c.breakParent(a), e.insertAfter(a);
                else if (c.appendBogus(!0), h || m)
  ...
  (function () {
    ...
    x.prototype = {
      exec: function (b) {
        ...
        for (var k = e.createBookmarks(!0), f = [], i = {}, c = c.createIterator(), h = 0;
          (g = c.getNextRange()) && ++h;) {
          ...
          if (a = f.shift(), this.state == CKEDITOR.TRISTATE_OFF)
            if (r[a.root.getName()]) {
              ...
              for (d = 0; d < h.contents.length; d++)
                if (l = h.contents[d], (l = l.getAscendant("li",
  ...
  (function () {
        ...
        a.on("contentDom", function () {
          ...
          d.is(w.$inline) || (b.inInlineMode && !W(d) && d.setStyles({
            ...
            d.attachListener(d, "keyup", function () {
              ...
              T(b)), a.addCommand("accessNextSpace", T(b, !0)), a.setKeystroke([
    ...
    var q = CKEDITOR.tools.extend,
      ...
      B = M.createFromHtml,
      o = CKEDITOR.env,
      da = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
      w = CKEDITOR.dtd,
      F = {},
      D = 128,
      Y = 64,
  ...
  CKEDITOR.plugins.add("scayt", {
        ...
        g = function () {
          ...
          d.attachListener(d, "focus", function () {
            ...
            if ((b || d) && a._.savedSelection)
              for (var d = a._.savedSelection.getSelectedElement(), d = !d && a._.savedSelection.getRanges(), i = 0; i < d.length; i++) f = d[i], "string" === typeof f.startContainer.$.nodeValue && (c = f.startContainer.getText().length, (c < f.startOffset || c < f.endOffset) && a.unlockSelection(!1))
          }, this, null, -10)
        },
        h = function () {
    ...
    menuGenerator: function (a, c) {
      ...
      for (var g in b) - 1 == CKEDITOR.tools.indexOf(e, g.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (f[g] = CKEDITOR.TRISTATE_OFF, "function" === typeof b[g].verification && !b[g].verification(a) && delete f[g], a.addCommand(g, {
        exec: b[g].exec
      }), a.addMenuItem(g, {
    ...
    if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
      ...
      a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
        return function () {
          ...
          else if (b = "ready" == this.status) var e = c.removeMarkupFromString(this.getSnapshot()),
